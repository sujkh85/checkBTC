...
function checkBatPattern(data) {
    ...
    if (Math.abs(AB - 0.382) < 0.1 && 
        Math.abs(BC - 0.382) < 0.1 && 
        Math.abs(CD - 0.886) < 0.1 &&
        Math.abs(XA - 0.886) < 0.1) {
        return 'Bat 매수 패턴 발견';
    } else if (Math.abs(AB - 0.382) < 0.1 && 
               Math.abs(BC - 0.382) < 0.1 && 
               Math.abs(CD - 0.886) < 0.1 &&
               Math.abs(XA - 0.886) < 0.1) {
        return 'Bat 매도 패턴 발견';
